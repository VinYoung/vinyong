package com.vin.user.configuration;

import com.vin.user.filter.JwtFilter;
import com.vin.user.shiro.ShiroRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Qualifier("securityManager") SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/common/notLogin");
        //未授权跳转路径
        shiroFilterFactoryBean.setUnauthorizedUrl("/common/notRole");
        //设置拦截链map
